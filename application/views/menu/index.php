                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#modalEdit<?= $m['id']; ?>" class="badge badge-primary" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fa fa-fw fa-pencil-alt"></i>Edit</a>
                ...
                <form action="<?= base_url('menu/editMenu'); ?>" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-fw fa-pencil-alt fa-sm">Edit</i>
                        </button>
                    </div>
                </form>
            </div>
